...
<body>
    <header id="header" class="header" style="background-color: black;opacity:0.7;padding:5px;">
        <h1 style="text-align:center;color:#2093e4;font-family: 'Kode Mono', monospace;">
            Sri S3 Overseas germany-University Form
        </h1>
    </header>
    <div class="container mt-5 pt-5">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 bg-light p-4 rounded  shadow">
                <form action="{{ route('germany_insert') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="specialty" value="{{ old('specialty') }}" class="form-control"
                            id="designation" placeholder="Your Designation" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="universityimage" value="{{ old('universityimage') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="discription_1" value="{{ old('discription_1') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="importance_1" value="{{ old('importance_1') }}"
                            class="form-control" id="name" placeholder="" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="importance_2" value="{{ old('importance_2') }}"
                            class="form-control" id="name" placeholder="" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="importance_3" value="{{ old('importance_3') }}"
                            class="form-control" id="name" placeholder="" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="discription_2" value="{{ old('discription_2') }}"
                            class="form-control" id="name" placeholder="" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" name="auxiliary_details" value="{{ old('auxiliary_details') }}"
                            class="form-control" id="auxiliary_details"
                            placeholder="Paste Auxiliary details Link OR # symbol" required>
