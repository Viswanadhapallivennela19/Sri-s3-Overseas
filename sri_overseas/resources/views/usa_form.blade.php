...
<body>
    <header id="header" class="header" style="background-color: black;opacity:0.7;padding:5px;">
        <h1 style="text-align:center;color:#2093e4;font-family: 'Kode Mono', monospace;">
            Sri S3 Overseas  USA-University Form
        </h1>      
    </header>
    <div class="container mt-5 pt-5">
        ...
        @endif
            ...
            <div class="col-lg-8 bg-light p-4 rounded  shadow">
                <form action="{{route('usa_insert')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="importance_1" value="{{old('importance_1')}}" class="form-control" id="name" placeholder="Acdemic Reputation" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="importance_2" value="{{old('importance_2')}}" class="form-control" id="name" placeholder="Location Details" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="discription_2" value="{{old('discription_2')}}" class="form-control" id="name" placeholder="University Importance" required>
