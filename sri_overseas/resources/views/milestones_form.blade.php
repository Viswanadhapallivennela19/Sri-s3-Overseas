...
<body>  
    <header id="header" class="header" style="background-color: black;opacity:0.7;padding:5px;">
        <h1 style="text-align:center;color:#2093e4;font-family: 'Kode Mono', monospace;">
            SriS<sub>3</sub>Overseas milestones Data
        </h1>
    </header>
    <div class="container mt-5 pt-5">
        ...
        @endif
            ...
            <div class="col-lg-8 bg-light p-4 rounded  shadow">
                <form action="{{route('milestones_insert')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="discription" value="{{old('discription')}}" class="form-control" id="name" placeholder="share your thoughts" required>
