...
<body>
    <header id="header" class="header" style="background-color: black;opacity:0.7;padding:5px;">
        <h1 style="text-align:center;color:#2093e4;font-family: 'Kode Mono', monospace;">
            Sri S3 Overseas Destinations Upload Form
        </h1>
    </header>
    <div class="container mt-5 pt-5">
        ...
        @endif
            ...
            <div class="col-lg-8 bg-light p-4 rounded  shadow">
                <form action="{{route('destination_insert')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    @enderror</div>
                    <div class="form-group">
                        <label for="email">Reason for Choosing</label>
                        <input type="text" name="famous" value="{{old('famous')}}" class="form-control" id="designation" placeholder="Your Designation" required>
